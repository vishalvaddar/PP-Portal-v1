...
// import timeTable from "./pages/Coordinator/TimeTableManagement";
// // --- Teacher pages ---
...
import Layout from "./Layout";
import LoginForm from "./components/login/LoginForm";
import { useAuth } from "./contexts/AuthContext"; // Note: 'useAuth' is imported but not used in this file.
...
import BatchReports from "./pages/Coordinator/BatchReports";
import AttendanceTracker from "./pages/Coordinator/AttendanceTracker";
// RENAMED import to avoid conflict with Teacher's TimeTable component
...
import StudentsList from "./pages/Teacher/StudentsList";
import AssignedBatches from "./pages/Teacher/AssignedBatches";
import TeacherTimeTable from "./pages/Teacher/TimeTable"; // RENAMED import to clarify usage
        ...
        children: [
            ...
            // --- Coordinator Routes ---
            {
                ...
                children: [
                    ...
                    { path: "batch-reports", element: <BatchReports /> },
                    { path: "attendance-tracker", element: <AttendanceTracker /> },
                    // UPDATED: Using the renamed import for Coordinator's Timetable
            ...
            // --- Teacher Routes ---
            {
                ...
                children: [
                    ...
                    { path: "students-list", element: <StudentsList /> },
                    { path: "assigned-batches", element: <AssignedBatches /> },
                    // UPDATED: Using the renamed import for Teacher's Timetable
